          ...
          {editing ? (
            ...
            <div className="space-y-4">
              <div className="flex justify-between py-3 border-b border-slate-100">
                ...
                <span className="font-medium text-slate-900">{userProfile?.full_name || '-'}</span>
              </div>
              ...
              {isCompany ? (
                <>
                  <div className="flex justify-between py-3 border-b border-slate-100">
                    ...
                    <span className="font-medium text-slate-900">{userProfile?.company_name || '-'}</span>
                  </div>
                  ...
                  <div className="flex justify-between py-3">
                    ...
                    <span className="font-medium text-slate-900">
                      {userProfile?.annual_turnover ? formatCurrency(userProfile.annual_turnover) : '-'}
                    </span>
                  </div>
                </>
              ) : (
                <div className="flex justify-between py-3">
                  ...
                  <span className="font-medium text-slate-900">
                    {userProfile?.monthly_salary ? formatCurrency(userProfile.monthly_salary) : '-'}
                  </span>
                </div>
              )}
            </div>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between py-3 border-b border-slate-100">
            <div>
              ...
              <p className="text-sm text-slate-500">Download all your tax calculations</p>
            </div>
        ...
        <div className="flex items-start space-x-4">
          ...
          <div>
            ...
            <p className="text-sm text-slate-600 mt-1">
              All calculations are based on the Nigeria Tax Act 2025, effective January 2026.
